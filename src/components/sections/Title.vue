...
// 最新消息
const news = "🔥 [2024-12-15] This robot project is still under development."

// 强调内容
const emphases = [
  "🎉 Welcome to our project",
  "🥰 I hope our work is helpful to you",
...
<template>
  <div>
    ...
    <el-row justify="center">
      <el-col :span="24">
        <el-alert title="🔥 The robotics research is still under development." type="success" />
      </el-col>
    </el-row>
